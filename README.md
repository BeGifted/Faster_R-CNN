...
* pycocotools(Win：pip install "git+https://github.com/philferriere/cocoapi.git#egg=pycocotools&subdirectory=PythonAPI")
* 最好使用GPU训练
...
* 如果想指定使用哪些GPU设备可在指令前加上`CUDA_VISIBLE_DEVICES=0,3`(例如只要使用设备中的第1块和第4块GPU设备)
