...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        images, targets = self.transform(images, targets)  # 对图像进行预处理 一个batch
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 rpn_fg_iou_thresh=0.7, rpn_bg_iou_thresh=0.3,  # rpn计算损失时，采集正负样本设置的阈值 （前景、背景）
        ...
        if rpn_anchor_generator is None:
            ...
            aspect_ratios = ((0.5, 1.0, 2.0),) * len(anchor_sizes)  # 重复5遍
        ...
        rpn = RegionProposalNetwork(
            ...
            rpn_batch_size_per_image, rpn_positive_fraction,  # rpn在计算损失时采用正负样本的总个数 | 正样本比例
